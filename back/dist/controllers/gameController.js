...
class GameController {
    constructor() {
        ...
        this.getPrematchListPent = (req, res) => __awaiter(this, void 0, void 0, function* () {
            if (!req.query.page)
                req.query.page = '1';
            const validateData = {
                page: {
        ...
        this.getPrematchCrossListPent = (req, res) => __awaiter(this, void 0, void 0, function* () {
            if (!req.query.page)
                req.query.page = '1';
            const validateData = {
                page: {
        ...
        this.getLiveListPent = (req, res) => __awaiter(this, void 0, void 0, function* () {
            if (!req.query.page)
                req.query.page = '1';
            const validateData = {
                page: {
            ...
            try {
                // ■■■■■■■■■■ DB-스포츠 경기 리스트 가져오기 ■■■■■■■■■■
                const r = yield gameService.getLiveListPent(v.page, v.sport);
                if (r.error) {
                    data.errorTitle = '스포츠 실패 - 500';
                    res.status(500).json(data);
                    return;
        ...
        this.getPrematchSpecialList = (req, res) => __awaiter(this, void 0, void 0, function* () {
            if (!req.query.page)
                req.query.page = '1';
            const validateData = {
                page: {
        ...
        this.getLiveKorList = (req, res) => __awaiter(this, void 0, void 0, function* () {
            if (!req.query.page)
                req.query.page = '1';
            const validateData = {
                page: {
        ...
        this.getGameResults = (req, res) => __awaiter(this, void 0, void 0, function* () {
            if (!req.query.page)
                req.query.page = '1';
            const validateData = {
                page: {
            ...
            try {
                // ■■■■■■■■■■ DB-경기결과 가져오기 ■■■■■■■■■■
                const r = yield gameService.getGameResults(v.page, v.sport);
                if (r.error) {
