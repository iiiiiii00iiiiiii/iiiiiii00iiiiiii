...
class Validate {
    ...
    validate(validateData) {
        ...
        this.first = null;
        this.data.validates = tools_1.default.deepClone(validateData);
    ...
    email(v) {
        let regExp = /[a-zA-Z0-9\-\_][\w\.-]*[a-zA-Z0-9\-\_]@[a-zA-Z0-9][\w\.-]*[a-zA-Z0-9]\.[a-zA-Z][a-zA-Z\.]*[a-zA-Z]$/;
        if (v.length == 0)
            return false;
    ...
    sanitize(v) {
        return (0, sanitize_html_1.default)(v, {
            allowedTags: []
        });
    }
}
