        ...
        <div class="col">
            ...
            <div class="row pt-2">
                ...
                <div class="col col-xl mt-2 mt-xl-0">
                    <div class="game-banner" data-aos="zoom-in" data-aos-duration="1500" @mouseover="bannerIndex = 3" @mouseout="bannerIndex = null" @click="user.id === 'justin' ? $tools.pushRouter('/casino', true) : $tools.ready()">
                        <div class="game-banner-site-name">
                            GOLDEN
                        </div>
                        <div class="game-banner-title">
            ...
            <div class="row">
                <div class="col">
                    <div class="copyright">
                        Copyright © 믿을 수 있는 GOLDEN SLUMBERS ALL RIGHTS RESERVE.<br>Solution By SOFT365.
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            async getDashboard() {
                const r = await this.$http.get('/api/get-dashboard', { n: 100 })
                if(r.error) return
