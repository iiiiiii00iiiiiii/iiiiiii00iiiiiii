    ...
    <div class="container-fluid">
            ...
            <div class="col py-1">
                <div class="row">
                    ...
                    <div class="col header-mobile-right-wrap text-right">
                        <img src="/images/ocean-mlogo.png" class="mlogo" @click="$tools.pushRouter('/', false)">
        ...
        >
            <div class="logo-wrap" v-show="!isLogin">
                <img src="/images/study-mobile.png" class="logo" alt="LOGO" title="LOGO" @click="$tools.pushRouter('/')">
            </div>
