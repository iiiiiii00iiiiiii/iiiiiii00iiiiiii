<template>
    ...
    >
        ...
        <div class="row" :class="index > 0 && v.games.underOverTotalSet[index].showStatus && v.games.underOverTotalSet[index].status !== 'HIDE' ? 'mt-1' : ''" v-for="(vv, index) in v.games.underOverTotalSet" :key="index">
            <div class="col-5 px-1" v-if="v.games.underOverTotalSet[index].showStatus && v.games.underOverTotalSet[index].status !== 'HIDE'">
                <div
                    ...
                    @click="v.games.underOverTotalSet[index].status === 'ACTIVE' ? $emit('setBet', {
                        _id: v._id,
                        sport: v.sport,
            ...
            <div class="col-2 px-1" v-if="v.games.underOverTotalSet[index].showStatus && v.games.underOverTotalSet[index].status !== 'HIDE'">
                <div
                    class="g-x"
                    :class="{
                        'n': v.games.underOverTotalSet[index].status !== 'ACTIVE',
