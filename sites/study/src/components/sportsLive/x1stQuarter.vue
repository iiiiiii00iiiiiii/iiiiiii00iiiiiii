<template>
    <div class="col-12 mt-3" v-if="v.games.x1stQuarter && v.showConfig.x1stQuarter && v.games.x1stQuarter[0].status !== 'HIDE' && v.games.x1stQuarter[0].showStatus">
        ...
        <div class="row">
            <div class="col-5 px-1">
                <div
                    ...
                    @click="v.games.x1stQuarter[0].status === 'ACTIVE' ? $emit('setBet', {
                        _id: v._id,
                        sport: v.sport,
                        type: 'x',
            ...
            <div class="col-2 px-1">
                <div
                    ...
                    @click="v.games.x1stQuarter[0].drawRate && v.games.x1stQuarter[0].status === 'ACTIVE' ? $emit('setBet', {
                        _id: v._id,
                        sport: v.sport,
                        type: 'x',
                        homeTeam: v.homeTeamKor ? v.homeTeamKor : v.homeTeam,
