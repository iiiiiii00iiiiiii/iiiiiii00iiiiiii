<template>
    ...
    >
        ...
        <div class="row" :class="index > 0 && v.games.handicap[index].showStatus && v.games.handicap[index].status !== 'HIDE' ? 'mt-1' : ''" v-for="(vv, index) in v.games.handicap" :key="index">
            <div class="col-5 px-1" v-if="v.games.handicap[index].showStatus && v.games.handicap[index].status !== 'HIDE'">
                <div
                    ...
                    @click="v.games.handicap[index].status === 'ACTIVE' ? $emit('setBet', {
                        _id: v._id,
                        sport: v.sport,
                        type: 'handicap',
            ...
            <div class="col-2 px-1" v-if="v.games.handicap[index].showStatus && v.games.handicap[index].status !== 'HIDE'">
                <div
                    class="g-x"
                    :class="{
                        'n': v.games.handicap[index].status !== 'ACTIVE'
