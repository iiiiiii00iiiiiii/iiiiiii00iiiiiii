<template>
    ...
    >
        <div class="mb-1 sports-detail-title">
            <font-awesome-icon :icon="['fa', 'chevron-circle-down']" class="text-warning"/> 양팀 득점 + 승무패
        </div>
        <div
            class="row"
        ...
        >
            ...
            <div class="col-3 px-1">
                <div
                    ...
                    @click="v.games.bothTeamsGoalWin[1].status === 'ACTIVE' ? $emit('setBet', {
                        _id: v._id,
                        sport: v.sport,
        ...
        >
            ...
            <div class="col-3 px-1">
                <div
                    ...
                    @click="v.games.bothTeamsGoalWin[0].status === 'ACTIVE' ? $emit('setBet', {
                        _id: v._id,
                        sport: v.sport,
                        type: 'bothTeamsGoalWin',
                        homeTeam: v.homeTeamKor ? v.homeTeamKor : v.homeTeam,
        ...
        >
            ...
            <div class="col-3 px-1">
                <div
                    ...
                    @click="v.games.bothTeamsGoalWin[2].status === 'ACTIVE' ? $emit('setBet', {
                        _id: v._id,
                        sport: v.sport,
                        type: 'bothTeamsGoalWin',
                        homeTeam: v.homeTeamKor ? v.homeTeamKor : v.homeTeam,
