        ...
        <div class="col-12">
            ...
            <div class="content-box">
                ...
                <div class="row">
                    <div class="col">
                        <div class="title">
                            스피드 사다리 <span>SPEED LADDER</span>
                        </div>
                    </div>
                    <div class="col-7 text-right d-none d-xl-block">
                        <div class="minigame-menu">
                            <ul>
                                ...
                                <li>
                                    <div class="active" @click="$tools.pushRouter('/speedladder', false)">스피드사다리</div>
                        ...
                        <div class="header-mobile-menu">
                            <div class="header-mobile-menu-wrap">
                                <ul>
                                    ...
                                    <li @click="$tools.pushRouter('/speedladder', true)">
                                        스피드사다리
                        ...
                        <div class="minigames px-xl-3">
                            ...
                            <div class="row mt-3">
                                <div class="col-2 col-md">
                                    <div
                                        ...
                                        :class="betType === 'SLDLR' && betSelect === 'Left' ? 'game-active' : ''"
                                ...
                                <div class="col-2 col-md">
                                    <div
                                        ...
                                        :class="betType === 'SLDLR' && betSelect === 'Right' ? 'game-active' : ''"
                                ...
                                <div class="col-2 col-md">
                                    <div
                                        class="btn-bet btn-bet-blue"
                                        :class="betType === 'SLDTF' && betSelect === 'Three' ? 'game-active' : ''"
                                ...
                                <div class="col-2 col-md">
                                    <div
                                        class="btn-bet btn-bet-red"
                                        :class="betType === 'SLDTF' && betSelect === 'Four' ? 'game-active' : ''"
                                ...
                                <div class="col-2 col-md">
                                    <div
                                        class="btn-bet btn-bet-blue"
                                        :class="betType === 'SLDOE' && betSelect === 'Odd' ? 'game-active' : ''"
                                ...
                                <div class="col-2 col-md">
                                    <div
                                        class="btn-bet btn-bet-red"
                                        :class="betType === 'SLDOE' && betSelect === 'Even' ? 'game-active' : ''"
                            ...
                            <div class="row mt-3">
                                <div class="col-3 col-md">
                                    <div
                                        class="btn-bet btn-bet-blue"
                                        :class="betType === 'SLDCOMBO' && betSelect === 'LeftThree' ? 'game-active' : ''"
                                ...
                                <div class="col-3 col-md">
                                    <div
                                        class="btn-bet btn-bet-blue"
                                        :class="betType === 'SLDCOMBO' && betSelect === 'LeftFour' ? 'game-active' : ''"
                                ...
                                <div class="col-3 col-md">
                                    <div
                                        class="btn-bet btn-bet-red"
                                        :class="betType === 'SLDCOMBO' && betSelect === 'RightThree' ? 'game-active' : ''"
                                ...
                                <div class="col-3 col-md">
                                    <div
                                        class="btn-bet btn-bet-red"
                                        :class="betType === 'SLDCOMBO' && betSelect === 'RightFour' ? 'game-active' : ''"
