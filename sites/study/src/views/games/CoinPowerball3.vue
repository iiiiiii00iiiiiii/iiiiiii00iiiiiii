        ...
        <div class="col-12">
            ...
            <div class="content-box">
                ...
                <div class="row">
                    <div class="col">
                        <div class="title">
                            코인 3분 파워볼 <span>COIN 3M POWERBALL</span>
                        </div>
                    </div>
                        ...
                        <div class="minigame-menu">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="mt-2 active" @click="$tools.pushRouter('/coinpowerball3', false)">코인 3분</div>
                                </li>
                                <li>
                        ...
                        <div class="header-mobile-menu">
                            <div class="header-mobile-menu-wrap">
                                <ul>
                                    ...
                                    <li @click="$tools.pushRouter('/coinpowerball3', false)">
                                        코인 3분
                            ...
                            <div class="row mt-1" v-show="!isHide">
                                <div class="col">
                                    <div class="row">
                                        <div class="col">
                                            <div class="broadcast">
                                                <div id="frame-wrap-dream">
                                                    <iframe class="iframe-game-dream" src="https://dr-score.com/minigame/broadcast/coinpowerball3" scrolling="no"></iframe>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            frameHandleResize() {
                ...
                if(sizeOfEleWidth > 789) {
                    document.querySelector('#frame-wrap-dream').style.width = '789px'
                    document.querySelector('#frame-wrap-dream').style.height = '609px'
                    document.querySelector('.iframe-game-dream').style.width = '789px'
                    document.querySelector('.iframe-game-dream').style.transform = 'scale(1.0)'
                }
                else {
                    document.querySelector('#frame-wrap-dream').style.width = '789px'
                    document.querySelector('.iframe-game-dream').style.width = '789px'
                    ...
                    document.querySelector('#frame-wrap-dream').style.width = sizeOfEleWidth + 'px'
                    document.querySelector('#frame-wrap-dream').style.height = sizeOfEleHeight + 'px'
                    document.querySelector('.iframe-game-dream').style.transform = 'scale(' + resizePercentOfWidth + ')'
                }
            },
            timeSet() {
                let term = this.$config.coinPowerball3Term
            ...
            async getGame() {
                let r = await this.$http.get('/api/get-coinpowerball3')

                if(!r.data) {
                    this.end = true
                    if(this.router === 'CoinPowerball3') {
