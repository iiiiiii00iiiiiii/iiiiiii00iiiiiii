                        ...
                        <div class="col">
                            <div class="sports">
                                <div class="row mb-2" v-for="(v, index) in data" :key="index">
                                    ...
                                    <div class="col-4 d-xl-none mt-2 mt-xl-3 pt-2 text-right g-date-mobile" v-if="data[index].leagueKor !== (index > 0 ? data[index - 1].leagueKor : null)">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            socketInit() {
                this.socket = this.$io.connect('https://live-study.thvmxm.com')
