                                ...
                                <div class="row mb-xl-2" v-for="(v, index) in data" :key="index">
                                    ...
                                    <div class="col-12 mt-2" :class="{ 'mb-3': index + 1 === data.length }">
                                        <div class="sports-px">
                                            ...
                                            <!-- 핸디캡 -->
                                            <div class="row mt-1 g" v-for="(itemHandi, indexHandi) in v.games.handicap" :key="`${v._id}-handi-${indexHandi}`" v-show="itemHandi.status === 'ACTIVE' && itemHandi.showStatus">
                                                <div class="col px-1 d-none d-xl-block">
                                                    <div class="g-date clearfix">
                                                        {{ $moment(v.gameDateTime).format("MM/DD HH:mm") }}
                                                    </div>
                                                ...
                                                <div class="col-5 col-xl-4 px-1">
                                                    <div
                                                        class="g-home can-bet clearfix"
                                                        :class="{
                                                            selectBet:betCart.findIndex((x) =>x._id === v._id &&x.type === 'handicap' && x.standard === itemHandi.homeStandard && x.select === 'home') > -1,
                                                        }"
                                                ...
                                                <div class="col-5 col-xl-4 px-1">
                                                    <div
                                                        class="g-away can-bet clearfix"
                                                        :class="{ selectBet: betCart.findIndex((x) =>x._id === v._id &&x.type === 'handicap' &&x.standard === itemHandi.homeStandard && x.select === 'away') > -1,}"
                                                        v-if="itemHandi.showStatus"
                                                        @click=" setBet({
                                                            _id: v._id,
                                                            sport: v.sport,
                                            ...
                                            <!-- 오버언더 -->
                                            <div class="row mt-1 g" v-for="(itemUnderOver, indexUnderOver) in v.games.underOver" :key="`${v._id}-overunder-${indexUnderOver}`" v-show="itemUnderOver.status === 'ACTIVE' && itemUnderOver.showStatus">
                                                <div class="col px-1 d-none d-xl-block">
                                                    <div class="g-date clearfix">
                                                        {{ $moment(v.gameDateTime).format("MM/DD HH:mm") }}
                                                    </div>
                                                ...
                                                <div class="col-5 col-xl-4 px-1">
                                                    <div
                                                        class="g-home can-bet clearfix"
                                                        :class="{selectBet: betCart.findIndex((x) =>x._id === v._id &&x.type === 'underOver' &&x.standard === itemUnderOver.standard &&x.select === 'over') > -1,}"
                                                ...
                                                <div class="col-5 col-xl-4 px-1">
                                                    <div
                                                        class="g-away can-bet clearfix"
                                                        :class="{selectBet:betCart.findIndex((x) =>x._id === v._id &&x.type === 'underOver' &&x.standard === itemUnderOver.standard &&x.select === 'under') > -1,}"
                                                        v-if="itemUnderOver.status"
                                                        @click="setBet({
                                                            _id: v._id,
                                                            sport: v.sport,
...
export default {
    ...
    computed: {
        ...
        numberOfPages() {
        return Math.ceil(this.dataCount / this.$config.pageSize) === 0
        ? 1
    ...
    methods: {
        ...
        setFromRouter() {
            ...
            this.search.sport = this.$route.query.sport
        ...
        setBet(v) {
            ...
            if(v.type === 'xKor' || (v.type === 'handicapKor' || v.type === 'handicapTotalSetKor' || v.type === 'handicapKor')) {
            ...
            if(v.sport !== 'Basketball' && v.sport !== 'Baseball') {
