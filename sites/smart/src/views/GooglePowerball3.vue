<template>
    <div class="row mb-3" data-aos="fade-in" data-aos-duration="1500">
        <div class="col page-content">
            ...
            <div class="row">
                <div class="col">
                    <div class="page-content-header powerball">
                        <font-awesome-icon :icon="['fa', 'gamepad']"/>
                        구글 3분 - <span>GOOGLE POWERBALL</span>
            ...
            <div class="row mt-1">
                <div class="col">
                    <div class="minigames">
                            ...
                            <div class="col-12">
                                <div class="minigame-info clearfix">
                                    <div class="float-left">
                                        <font-awesome-icon :icon="['fa', 'star']" class="text-light-brown"/> 구글 3분-<span class="text-light-brown">{{ round }}</span> (<span class="text-light-brown">{{ rotation }}</span>) 회차
                                    </div>
                        ...
                        <!-- PC 파워볼 -->
                        <div class="row mt-1 d-none d-md-flex px-2">
                            <div class="col">
                        ...
                        <div class="row my-1 d-none d-md-flex px-2">
                            <div class="col">
                                <div
