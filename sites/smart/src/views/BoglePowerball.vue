            ...
            <div class="row mt-1">
                <div class="col">
                    <div class="minigames">
                            ...
                            <div class="col-12">
                                <div class="minigame-info clearfix">
                                    <div class="float-left">
                                        <font-awesome-icon :icon="['fa', 'star']"/> 보글 파워볼-<span>{{ round }}</span> (<span>{{ rotation }}</span>) 회차
                                    </div>
                        ...
                        <!-- PC-파워볼 -->
                        <div class="row mt-1 d-none d-xl-flex px-2">
                            <div class="col">
                        ...
                        <div class="row my-1 d-none d-xl-flex px-2">
                            <div class="col">
                                <div
