<template>
    <div class="row">
        <div class="col-12 main-content-wrap">
            ...
            <div class="bottom-contents d-none d-xl-block">
                <div class="row">
                    <div class="col-4 col-xl-2 cursor-pointer">
                        <img src="/images/banner-1.png" class="img-fluid" alt="SPORTS" title="SPORTS">
                        <div class="plar">
                            <div class="plar-btn" data-hover="Play Now" @click="$tools.pushRouter('/sports', true)">
                                유럽형 스포츠
                            </div>
                        </div>
                    </div>
                    <div class="col-4 col-xl-2 cursor-pointer">
                        ...
                        <div class="plar">
                            <div class="plar-btn" data-hover="Play Now" @click="$tools.pushRouter('/sportscross', true)">
                                국내형 스포츠
                            </div>
                        </div>
                    </div>
                    <div class="col-4 col-xl-2 cursor-pointer">
                        ...
                        <div class="plar">
                            <div class="plar-btn" data-hover="Play Now" @click="$tools.pushRouter('/sportsspecial', true)">
                                스페셜 스포츠
                            </div>
                        </div>
                    </div>
                    <div class="col-4 col-xl-2 cursor-pointer mt-2 mt-xl-0">
                        <img src="/images/banner-4.png" class="img-fluid" alt="MNIGAME" title="MNIGAME">
                        <div class="plar">
                            <div class="plar-btn" data-hover="Play Now" @click="$tools.pushRouter('/MiniGameMenu', true)">
                                미니게임
                            </div>
                        </div>
                    </div>
                    <div class="col-4 col-xl-2 cursor-pointer mt-2 mt-xl-0">
                        ...
                        <div class="plar">
                            <div class="plar-btn" data-hover="Play Now" @click="$tools.pushRouter('/casino', true)">
                                라이브 카지노
                            </div>
                        </div>
                    </div>
                    <div class="col-4 col-xl-2 cursor-pointer mt-2 mt-xl-0">
                        ...
                        <div class="plar">
                            <div class="plar-btn" data-hover="Play Now" @click="openKplay(0)">
                                슬롯게임
                            </div>
                        </div>
                    </div>
