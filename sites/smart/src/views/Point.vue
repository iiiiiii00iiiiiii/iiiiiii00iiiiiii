    ...
    <div class="row" data-aos="fade-in" data-aos-duration="1500">
        <div class="col page-content ">
            <div class="page-content-header">
                ...
                포인트 전환 - <span>POINT</span>
            </div>
            <div class="content-notice">
                <div>※ 포인트 전환 유의사항 ※</div>
                <div>최소 <span>1원</span> 이상부터 전환 가능 합니다.</div>
            </div>
            <div class="page-content-middle mt-2">
                <div class="row">
                    <div class="col-7 col-xl-2">
                        <div class="title">
                            보유포인트 : {{$numeral(user.point).format('0,0')}}
                        </div>
                    </div>
