        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-2 header-mobile-right-wrap">
                    <span v-show="!isLogin" @click="$tools.pushRouter('/login', false)">
                        <font-awesome-icon :icon="['fa', 'sign-out-alt']" class="icon-mobile-sign-in-alt"/>
                    </span>
                    <span class="cart-count-box">
                        <span class="cart-count" v-show="isLogin" @click="openRightSide()"> {{ betCart.length }} </span>
                    </span>
                    <span v-show="isLogin" @click="openRightSide()">
                        <font-awesome-icon :icon="['fa', 'shopping-cart']" class="icon-mobile-sign-in-alt"/>
                    </span>
                </div>
            </div>
            <div class="row mt-1">
                    ...
                    <div class="header-mobile-menu">
                        <div class="header-mobile-menu-wrap">
                            <ul>
                                ...
                                <li @click="$tools.pushRouter('/minigamemenu', false)">
