                ...
                <div class="col">
                    <div class="page-title-wrap">
                        <div class="page-title">
                            ...
                            <span class="ml-2">구글 1분 GOOGLE POWERBALL</span>
                            ...
                            <div class="col-12">
                                <div class="minigame-info clearfix">
                                    <div class="float-left">
                                        <font-awesome-icon :icon="['fa', 'star']" class="text-light-brown"/> 구글 1분-<span class="text-light-brown">{{ round }}</span> (<span class="text-light-brown">{{ rotation }}</span>) 회차
                                    </div>
