                    ...
                    <div class="page-title-wrap">
                        <div class="page-title">
                            ...
                            <span class="float-right">
                                <button type="button" class="btn-board" :disabled="loading" @click="$tools.pushRouter('/sports')">
                    ...
                    <div class="col">
                        <div class="sports">
                                            ...
                                            <div class="col-12 my-2 p-3 game-detail">
                                                ...
                                                <div class="row p-3 expand-game">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <div class="col-6 pl-1 pl-xl-2 g-explain">
                                                                양팀 득점+홈승
                                                            </div>
                                                            <div
                                                    ...
                                                    >
                                                        ...
                                                        <div class="row">
                                                            <div
                                                                class="col-4 g-home-correct can-bet"
                                                                :class="{
                            ...
                            <infinite-loading @infinite="infiniteHandler" ref="InfiniteLoading" spinner="waveDots">
                                <div slot="no-more">마지막 페이지 입니다</div>
                                <div slot="no-results">마지막 페이지 입니다</div>
                            </infinite-loading>
                        </div>
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            setFromRouter() {
                ...
                this.search.countryKor = this.$route.query.countryKor ? this.$route.query.countryKor : ''
            ...
            linkGen(page) {
                return `?page=${page}&sport=${this.search.sport}&countryKor=${this.search.countryKor}&league=${this.search.league}`
            },
            async getList() {
                this.overlay = true
                let r = await this.$http.get('/api/get-prematch-list-modern', this.search)
                this.overlay = false
                if(r.error) return
            ...
            async infiniteHandler($state) {
                try {
                    const r = await this.$http.get('/api/get-prematch-list-modern', this.search)
                    this.search.page++
