<template>
    <div class="left-menu">
        ...
        <table class="w-100">
            ...
            <tr>
                <td class="py-2 menu-5" @click="$tools.pushRouter('/sportslivekor', false)">실시간</td>
                <td class="py-2 menu-6" @click="$tools.pushRouter('/powerball', false)">미니게임</td>
                <td class="py-2 menu-7" @click="$tools.ready()">카지노</td>
                <td class="py-2 menu-3" @click="$tools.ready()">슬롯</td>

            </tr>
            <tr>
                <td class="py-2 menu-1" @click="$tools.pushRouter('/betlist', true)">배팅내역</td>
                <td class="py-2 menu-2" @click="$tools.pushRouter('/gameresults', false)">경기결과</td>
                <td class="py-2 menu-8" @click="$tools.pushRouter('/notice', true)">공지사항</td>
                <td class="py-2 menu-5" @click="$tools.pushRouter('/event', true)">이벤트</td>

            </tr>
            <tr>
                <td class="py-2 menu-3" @click="$tools.pushRouter('/rules', true)">이용규정</td>
                <td class="py-2 menu-6" @click="$tools.pushRouter('/point', true)">포인트</td>
                <td class="py-2 menu-1" @click="$tools.pushRouter('/mypage', true)">내정보</td>
            </tr>
        </table>
    </div>
</template>
