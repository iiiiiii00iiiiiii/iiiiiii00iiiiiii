    ...
    <div class="row">
        <div class="col">
            ...
            <div class="row pt-2">
                ...
                <div class="col col-xl mt-2 mt-xl-0">
                    <div class="game-banner" data-aos="zoom-in" data-aos-duration="1500" @mouseover="bannerIndex = 3" @mouseout="bannerIndex = null" @click="$tools.pushRouter('/sportsspecial', false)">
                        ...
                        <img src="/images/banner-9.jpg" alt="SPECIAL" title="SPECIAL">
                    </div>
                </div>
                <div class="col col-xl d-none d-xl-block">
                    <div class="game-banner" data-aos="zoom-in" data-aos-duration="1500" @mouseover="bannerIndex = 4" @mouseout="bannerIndex = null" @click="user.id === 'justin' ? openKplay(0) : $tools.ready()">
                        <div class="game-banner-site-name">
                            PentHouse
                        </div>
                        <div class="game-banner-title">
            ...
            <!-- <div class="row mt-2">
                ...
                <div class="col-3 col-xl">
                    <div class="game-banner" data-aos="zoom-in" data-aos-duration="1500" @click="$tools.pushRouter('/sportsspecial', false)">
                        <img src="/images/banner-3.png" alt="LIVE" title="LIVE">
                    </div>
                </div>
                <div class="col-3 col-xl">
            ...
            <div class="row">
                <div class="col">
                    <div class="copyright">
                        Copyright © 믿을 수 있는 PentHouse BET ALL RIGHTS RESERVE.<br>Solution By SOFT365.
                    </div>
                </div>
            </div>
        </div>
