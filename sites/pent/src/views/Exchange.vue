                ...
                <div class="col">
                    <div class="page-title-wrap">
                        <div class="page-title">
                            ...
                            <span class="ml-2">환전 EXCHANGE</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="money-notice-wrap">
                        ...
                        <ul class="money-notice-content">
                            <li>
                                ...
                                24시간 환전이 가능하며 5~15분 소요됩니다.
                            </li>
                            <li>
                                <font-awesome-icon class="icon-caret" :icon="['fa', 'caret-right']"/>
                                15분이상 환전 지연시 고객센터로 문의 바랍니다.
                            </li>
                            <li>
                                <font-awesome-icon class="icon-caret" :icon="['fa', 'caret-right']"/>
                                10,000원 이상 환전 가능합니다.
                            ...
                            <li class="imp">
                                <font-awesome-icon class="icon-caret" :icon="['fa', 'caret-right']"/>
                                23:30~00:30 은행 점검시간에는 환전 불가능합니다.
                            </li>
                        </ul>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // [환전 신청]
            async exchange() {
                const r = await this.$http.post('/api/set-exchange-pent', {
                ...
                this.$tools.sw('success', '환전 신청 성공', '환전 신청이 완료되었습니다.', null, this.getList)
                this.getInformation()
            },
            // [환전 내역 삭제]
            async deleteExchange(_id) {
                this.$sw.fire({
                    ...
                    if(result.value) {
                        ...
                        this.$tools.sw('success', '환전 내역 삭제 성공', '환전 내역이 삭제 되었습니다.', null, this.getList)
                    }
                })
            },
            async deleteExchangeAll(_id) {
                this.$sw.fire({
                    ...
                    if(result.value) {
                        ...
                        this.$tools.sw('success', '환전 내역 전체 삭제 성공', '환전 내역이 전체 삭제 되었습니다.', null, this.getList)
                    }
                })
            },
            addMoney(amount) {
