...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            socketInit() {
                this.socket = this.$io.connect('https://live-pent.thvmxm.com')
            ...
            async getList() {
                this.overlay = true
                let r = await this.$http.get('/api/get-live-list-pent', this.search)
                this.overlay = false
                if(r.error) return
            ...
            expandGame(v) {
                ...
                if(v.games.handicap && v.games.handicap.length > 1) {
                    ...
                    if(v.games.handicap.length > 1) v.games.handicap.pop()
                }
                //  오버언더 정렬
                if(v.games.underOver && v.games.underOver.length > 1) {
                    ...
                    if(v.games.underOver.length > 1) v.games.underOver.pop()
                }
                //  1이닝 핸디캡 정렬
                ...
                //  1쿼터 핸디캡 정렬
                if(v.games.handicap1stQuarter && v.games.handicap1stQuarter.length > 1) {
                    v.games.handicap1stQuarter.sort((a, b) => {
                        return (a.homeStandard < b.homeStandard) ? -1 : (a.homeStandard > b.homeStandard) ? 1: 0
                    })
                    if(v.games.handicap1stQuarter.length > 1) v.games.handicap1stQuarter.pop()
                }
                //  1쿼터 오버언더 정렬
                if(v.games.underOver1stQuarter && v.games.underOver1stQuarter.length > 1) {
                    v.games.underOver1stQuarter.sort((a, b) => {
                        return (a.standard < b.standard) ? -1 : (a.standard > b.standard) ? 1: 0
                    })
                    if(v.games.underOver1stQuarter.length > 1) v.games.underOver1stQuarter.pop()
                }
                //  2쿼터 핸디캡 정렬
                if(v.games.handicap2ndQuarter && v.games.handicap2ndQuarter.length > 1) {
                    v.games.handicap2ndQuarter.sort((a, b) => {
                        return (a.homeStandard < b.homeStandard) ? -1 : (a.homeStandard > b.homeStandard) ? 1: 0
                    })
                    if(v.games.handicap2ndQuarter.length > 1) v.games.handicap2ndQuarter.pop()
                }
                //  2쿼터 오버언더 정렬
                if(v.games.underOver2ndQuarter && v.games.underOver2ndQuarter.length > 1) {
                    v.games.underOver2ndQuarter.sort((a, b) => {
                        return (a.standard < b.standard) ? -1 : (a.standard > b.standard) ? 1: 0
                    })
                    if(v.games.underOver2ndQuarter.length > 1) v.games.underOver2ndQuarter.pop()
                }
                //  3쿼터 핸디캡 정렬
                if(v.games.handicap3rdQuarter && v.games.handicap3rdQuarter.length > 1) {
                    v.games.handicap3rdQuarter.sort((a, b) => {
                        return (a.homeStandard < b.homeStandard) ? -1 : (a.homeStandard > b.homeStandard) ? 1: 0
                    })
                    if(v.games.handicap3rdQuarter.length > 1) v.games.handicap3rdQuarter.pop()
                }
                //  3쿼터 오버언더 정렬
                if(v.games.underOver3rdQuarter && v.games.underOver3rdQuarter.length > 1) {
                    v.games.underOver3rdQuarter.sort((a, b) => {
                        return (a.standard < b.standard) ? -1 : (a.standard > b.standard) ? 1: 0
                    })
                    if(v.games.underOver3rdQuarter.length > 1) v.games.underOver3rdQuarter.pop()
                }
                //  4쿼터 핸디캡 정렬
                if(v.games.handicap4thQuarter && v.games.handicap4thQuarter.length > 1) {
                    v.games.handicap4thQuarter.sort((a, b) => {
                        return (a.homeStandard < b.homeStandard) ? -1 : (a.homeStandard > b.homeStandard) ? 1: 0
                    })
                    if(v.games.handicap4thQuarter.length > 1) v.games.handicap4thQuarter.pop()
                }
                //  4쿼터 오버언더 정렬
                if(v.games.underOver4thQuarter && v.games.underOver4thQuarter.length > 1) {
                    v.games.underOver4thQuarter.sort((a, b) => {
                        return (a.standard < b.standard) ? -1 : (a.standard > b.standard) ? 1: 0
                    })
                    if(v.games.underOver4thQuarter.length > 1) v.games.underOver4thQuarter.pop()
                }
                //  1피리어드 핸디캡 정렬
