                            ...
                            <div class="col">
                                <div class="card bet-card mb-3" v-for="(v, index) in data" :key="index">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- <div class="d-none">
                                            <div v-for="(vv, ii) in v.detail" :key="ii" :class="ii > 0 ? 'wrap-bet-list-mobile' : ''">
                                                <div class="row">
                                                    <div class="col-6 bg-bet-list-title-mobile">경기시간</div>
                                                    <div class="col-6 bg-bet-list-content-mobile">{{ $moment(vv.gameDateTime).format('MM/DD HH:mm') }}</div>
                                                    <div class="col-6 bg-bet-list-title-mobile">경기 타입</div>
                                                    <div class="col-6 bg-bet-list-content-mobile">{{ $config.convertBetTypeSports[vv.type] }}</div>
                                                    <div class="col-6 bg-bet-list-title-mobile">리그</div>
                                                    <div class="col-6 bg-bet-list-content-mobile">
                                                        <img :src="`/images/${$config.iconSport[vv.sport]}`" class="sports-img">
                                                        {{ vv.leagueKor }}
                                                    </div>
                                                    <div class="col-6 bg-bet-list-title-mobile">홈팀</div>
                                                    <div class="col-6 bg-bet-list-content-mobile">{{ vv.homeTeam }}</div>
                                                    <div class="col-6 bg-bet-list-title-mobile">원정 팀</div>
                                                    <div class="col-6 bg-bet-list-content-mobile">{{ vv.awayTeam }}</div>
                                                    <div class="col-6 bg-bet-list-title-mobile">배팅</div>
                                                    <div class="col-6 bg-bet-list-content-mobile">
                                                        <span>{{ $config.convertBetTypeSports[vv.type] }}</span>
                                                        <span v-if="vv.standard || vv.standard === 0">
                                                            [{{
                                                    ...
                                                    <div class="col-6 bg-bet-list-title-mobile">배당</div>
                                                    <div class="col-6 bg-bet-list-content-mobile">{{ $numeral(vv.finalRate).format('0.00') }}</div>

                                                    <div class="col-6 bg-bet-list-title-mobile">상태</div>
                                                    <div class="col-6 bg-bet-list-content-mobile" :class="$config.sportsResultTextColor[vv.betResult]">{{ $config.result[vv.betResult] }}</div>

                                                    <div class="col-6 bg-bet-list-title-mobile">결과</div>
                                                    <div class="col-6 bg-bet-list-content-mobile">
                                                        <span v-if="vv.betResult !== 'I'">
                                                            <span v-if="$config.specialGameType.indexOf(vv.type) > -1">
                                                                {{ displaySpecialScore(vv.type, vv.select, vv.betResult) }}
...
<style lang="scss" scoped>
    ...
    .wrap-bet-list-mobile {
        margin-top: 1rem;
    }

    .bg-bet-list-title-mobile {
