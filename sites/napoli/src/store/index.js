...
export default new Vuex.Store({
    ...
    getters: {
        ...
        // 카테고리 개수
        countOfCategory: state => {
            return state.countOfCategory
        }
    },
    mutations: {
        // 버튼 상태
        ...
        // 카테고리 갯수
        setCountOfCategory: (state, payload) => {
            state.countOfCategory = payload
        }
    },
    actions: {
        // 버튼 상태
        ...
        // 카테고리 갯수
        setCountOfCategory: ({ commit }, payload) => {
            commit('setCountOfCategory', payload)
        },
