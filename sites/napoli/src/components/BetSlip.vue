    ...
    export default {
        ...
        methods: {
            ...
            bet() {
                ...
                else if(this.router === 'Powerball' || this.router === 'Powerladder' || this.router === 'Kenoladder' || this.router === 'BoglePowerball' || this.router === 'Bogleladder' || this.router === 'GooglePowerball1' || this.router === 'GooglePowerball3' || this.router === 'EosPowerball' || this.router === 'EosPowerball3' || this.router === 'EosPowerball1') {
                    betCart = this.betCart
                    betURL = '/api/bet'
                ...
                this.$sw.fire({
                    ...
                    if(result.value) {
                        ...
                        if(this.router === 'Powerball' || this.router === 'Powerladder' || this.router === 'Kenoladder' || this.router === 'BoglePowerball' || this.router === 'Bogleladder' || this.router === 'GooglePowerball1' || this.router === 'GooglePowerball3' || this.router === 'EosPowerball' || this.router === 'EosPowerball3' || this.router === 'EosPowerball1') {
