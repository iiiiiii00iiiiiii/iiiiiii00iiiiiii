const config = {
    ...
    coinPowerball3Time: parseInt(process.env.VUE_APP_COINPOWERBALL3_TIME),
    coinPowerballTime: parseInt(process.env.VUE_APP_COINPOWERBALL_TIME),
    eosPowerball1Time: parseInt(process.env.VUE_APP_EOSPOWERBALL1_TIME),
    eosPowerball3Time: parseInt(process.env.VUE_APP_EOSPOWERBALL3_TIME),
    eosPowerballTime: parseInt(process.env.VUE_APP_EOSPOWERBALL_TIME),
    speedLadderTime: parseInt(process.env.VUE_APP_SPEEDLADDER_TIME),
