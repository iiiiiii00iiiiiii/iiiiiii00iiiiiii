const config = {
    ...
    eosPowerball1Term: parseInt(process.env.VUE_APP_EOSPOWERBALL1_TIME),
    ...
    speedladderTerm: parseInt(process.env.VUE_APP_SPEEDLADDER_TIME),

    kenoTerm: parseInt(process.env.VUE_APP_KENO_TIME),
    ...
    convertBetSelectMinigames: {
        ...
        SLDCOMBO: {
            LeftThree: '스피드 사다리 [좌3]',
            LeftFour: '스피드 사다리 [좌4]',
            RightThree: '스피드 사다리 [우3]',
            RightFour: '스피드 사다리 [우4]'
        }
    },
    convertMiniGameType: {
        powerball: '파워볼',
