                                            ...
                                            <tr v-for="(item, index) in data" :key="index">
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        ...
                                                        @click="$tools.pushRouter(`/faq/detail/${item._id}/${search.page}`)"
                                                    >
                                                        {{ item.title }}
                                                    </span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="font-weight-bold text-inf">META</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async getList() {
                const r = await this.$http.get('/api/get-faq-list', this.search)
                if(r.error) return
