        ...
        <div class="col-12">
            ...
            <div class="content-box">
                ...
                <div class="row">
                    <div class="col">
                        <div class="title">
                            이오스 파워볼 <span>EOS POWERBALL</span>
                        </div>
                    </div>
                        ...
                        <div class="minigame-menu">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="mt-2 active" @click="$tools.pushRouter('/eospowerball', false)">EOS 5분</div>
                                </li>
                                <li>
                        ...
                        <div class="header-mobile-menu">
                            <div class="header-mobile-menu-wrap">
                                <ul>
                                    ...
                                    <li @click="$tools.pushRouter('/eospowerball', false)">
                                        EOS 5분
                                        ...
                                        <div class="col">
                                            <div class="broadcast">
                                                <div id="frame-wrap-bepick">
                                                    <iframe class="iframe-game-bepick" src="https://bepick.net/live/eosball5m" scrolling="no"></iframe>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            timeSet() {
                let term = this.$config.eosPowerballTerm
            ...
            async getGame() {
                let r = await this.$http.get('/api/get-eospowerball')

                if(!r.data) {
                    this.end = true
                    if(this.router === 'EosPowerball') {
