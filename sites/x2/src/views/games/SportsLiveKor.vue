                        ...
                        <div class="col">
                            <div class="sports">
                                <div class="row mb-2" v-for="(v, index) in data" :key="index">
                                    <div class="col-8 col-xl-12 mt-2 g-league-mobile" v-if="data[index].leagueKor !== (index > 0 ? data[index - 1].leagueKor : null)">
                                    ...
                                    <div class="col-12 mt-1" :class="{'mb-3': index + 1 === data.length}">
                                        <div class="sports-px">
                                            ...
                                            <div class="row g"
                                                ...
                                                "
                                            >
                                                <div class="col-12 d-xl-none px-1">
                                                    <div class="kor-live">
                                                        실시간 2쿼터
                                                    </div>
                                                </div>
    ...
    export default {
        ...
        methods: {
            ...
            async infiniteHandler($state) {
                try {
                    const r = await this.$http.get('/api/get-live-kor-list', this.search)
                    this.search.page++
