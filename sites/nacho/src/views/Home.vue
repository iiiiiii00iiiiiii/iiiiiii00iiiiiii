<template>
    <div class="row">
        <div class="col">
            ...
            <div class="row mt-3">
                <div class="col-3 col-xl">
                    <div class="game-banner" data-aos="zoom-in" data-aos-duration="1500" @click="$tools.ready('/casino', true)">
            ...
            <div class="row">
                <div class="col">
                    <div class="copyright">
                        Copyright © 믿을 수 있는 NACHO BET ALL RIGHTS RESERVE.<br>Solution By SOFT365.
                    </div>
                </div>
            </div>
        </div>
