<template>
    <div class="row">
        <div class="col">
            ...
            <div class="row">
                <div class="col-12 main-banner d-none d-xl-block">
                    <b-carousel
                        id="carousel-1"
                        :interval="3000"
                        fade
                        ...
                        img-width="1024"
                    >
                        <b-carousel-slide img-src="images/main-banner-01.jpg"></b-carousel-slide>
                        <b-carousel-slide img-src="images/main-banner-02.jpg"></b-carousel-slide>
                    </b-carousel>
                </div>
            ...
            <!-- <div class="row pt-2 d-none d-xl-flex">
                <div class="col">
                    <div class="board" data-aos="zoom-in" data-aos-duration="1500">
                        <div class="board-title">
                            <span class="home-board-title">공지사항</span>
                            <span class="home-board-more float-right" @click="$tools.pushRouter(`/${selectBoard}`, true)">+more</span>
                        </div>
                ...
                <div class="col">
                    <div class="board" data-aos="zoom-in" data-aos-duration="1500">
                        <div class="board-title">
                            <span class="home-board-title">이벤트</span>
                            <span class="home-board-more float-right" @click="$tools.pushRouter('/event', true)">+more</span>
                        </div>
                        <div class="board-content">
                            <ul>
                ...
                <div class="col">
                    <div class="board" data-aos="zoom-in" data-aos-duration="1500">
                        <div class="board-title">
                            <span class="home-board-title">FAQ</span>
                            <span class="home-board-more float-right" @click="$tools.pushRouter('/faq', true)">+more</span>
                        </div>
                        <div class="board-content">
                            <ul>
            ...
            <div class="row pt-2">
                ...
                <div class="col col-xl mt-2 mt-xl-0">
                    <div class="game-banner" data-aos="zoom-in" data-aos-duration="1500" @mouseover="bannerIndex = 3" @mouseout="bannerIndex = null" @click="$tools.pushRouter('/sportsspecial', false)">
                        <div class="game-banner-site-name">
                            MODERN TIMES
                        </div>
                        <div class="game-banner-title">
                            <font-awesome-icon :icon="['fa', 'cubes']"/> SPECIAL
                        </div>
                        ...
                        <img src="/images/banner-7.jpg" alt="LIVE CASINO" title="LIVE CASINO">
                    </div>
                </div>
                <!-- 슬롯 - PC -->
                <div class="col col-xl d-none d-xl-block">
                    <div class="game-banner" data-aos="zoom-in" data-aos-duration="1500" @mouseover="bannerIndex = 4" @mouseout="bannerIndex = null" @click="$tools.pushRouter('/powerball', false)">
                        ...
                        <div class="game-banner-title">
                            <font-awesome-icon :icon="['fa', 'cubes']"/> MINI GAMES
                        </div>
            ...
            <!-- <div class="row d-xl-none">
                <div class="col-12 mt-2">
                    <div class="board" data-aos="zoom-in" data-aos-duration="1500">
                        <div class="board-title">
                            <span @click="selectBoard = 'notice'">공지사항</span>
                ...
                <div class="col-12 mt-2">
                    <div class="board" data-aos="zoom-in" data-aos-duration="1500">
                        <div class="board-title">
                            <span>FAQ</span>
                            <span class="float-right text-light-brown" @click="$tools.pushRouter('/faq', true)">+more</span>
                        </div>
                        <div class="board-content">
                            <ul>
                                <li v-for="(item, index) in faq" :key="index">
            ...
            <div class="row">
                <div class="col">
                    <div class="copyright">
                        Copyright © 믿을 수 있는 MODERN TIMES ALL RIGHTS RESERVE.<br>Solution By SOFT365.
                    </div>
                </div>
            </div>
        </div>
