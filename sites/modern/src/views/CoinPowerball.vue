                ...
                <div class="col">
                    <div class="page-title-wrap">
                        <div class="page-title">
                            ...
                            <span class="ml-2">코인 5분 COIN POWERBALL</span>
                            ...
                            <div class="col-12">
                                <div class="minigame-info clearfix">
                                    <div class="float-left">
                                        <font-awesome-icon :icon="['fa', 'star']" class="text-light-brown"/> 코인 5분-<span class="text-light-brown">{{ round }}</span> (<span class="text-light-brown">{{ rotation }}</span>) 회차
                                    </div>
