        ...
        <div class="col-12">
            ...
            <div class="content-box">
                ...
                <div class="row">
                    <div class="col">
                        <div class="title">
                            구글 3분 파워볼 <span>GOOGLE POWERBALL 3M</span>
                        </div>
                    </div>
                        ...
                        <div class="minigame-menu">
                            <ul>
                                <li>
                                    ...
                                    <div class="active mt-2" @click="$tools.pushRouter('/googlepowerball3', false)">구글 3분</div>
                                </li>
                                <li>
                ...
                <div class="row mt-3">
                    <div class="col">
                        <div class="minigames px-xl-3">
                            <div class="row mt-1" v-show="!isHide">
                                <div class="col">
                                    <div class="row">
                                        <div class="col">
                                            <div class="broadcast">
                                                <div id="frame-wrap-trust">
                                                    <iframe class="iframe-game-trust" src="https://game.tspick.com/bong/TRUST_POWERBALL/?kind=pick_powerball2" scrolling="no"></iframe>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!-- MOBILE-파워볼 -->
                            <div class="row mt-3 font-weight-bold d-md-none" id="section1">
                            ...
                            <!-- MOBILE-일반볼 -->
                            <div class="row mt-3 font-weight-bold d-md-none" id="section2">
                            ...
                            <!-- MOBILE-파워볼 조합 -->
                            <div class="row mt-3 font-weight-bold d-md-none" id="section3">
                            ...
                            <!-- MOBILE-일반볼 조합 -->
                            <div class="row mt-3 font-weight-bold d-md-none" id="section4">
                                <div class="col-12 text-center">
                                    일반볼 홀/짝 + 언더/오버
                                </div>
                            </div>
                            ...
                            <!-- MOBILE-일반볼 대중소 조합 -->
                            <div class="row mt-3 font-weight-bold d-md-none" id="section5">
                                <div class="col-12">
                                    일반볼 홀/짝 + 대/중/소
                                </div>
                            </div>
        ...
        methods: {
            ...
            frameHandleResize() {
                ...
                if(sizeOfEleWidth > 830) {
                    document.querySelector('#frame-wrap-trust').style.width = '100%'
                    document.querySelector('#frame-wrap-trust').style.height = '553px'
                    document.querySelector('.iframe-game-trust').style.width = '100%'
                    document.querySelector('.iframe-game-trust').style.transform = 'scale(1.0)'
                }
                else {
                    document.querySelector('#frame-wrap-trust').style.width = '830px'
                    document.querySelector('.iframe-game-trust').style.width = '830px'

                    let sizeOfWidth = 830
                    let sizeOfHeight = 553
                    ...
                    document.querySelector('#frame-wrap-trust').style.width = sizeOfEleWidth + 'px'
                    document.querySelector('#frame-wrap-trust').style.height = sizeOfEleHeight + 'px'
                    document.querySelector('.iframe-game-trust').style.transform = 'scale(' + resizePercentOfWidth + ')'
                }
            },
            timeSet() {
                let term = this.$config.googlePowerball3Term
            ...
            async getGame() {
                let r = await this.$http.get('/api/get-googlepowerball3')

                if(!r.data) {
                    this.end = true
                    if(this.router === 'GooglePowerball3') {
