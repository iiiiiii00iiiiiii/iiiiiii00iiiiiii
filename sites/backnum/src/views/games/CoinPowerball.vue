        ...
        <div class="col-12">
            ...
            <div class="content-box">
                ...
                <div class="row">
                    <div class="col">
                        <div class="title">
                            코인 파워볼 <span>COIN POWERBALL</span>
                        </div>
                    </div>
                        ...
                        <div class="minigame-menu">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="mt-2 active" @click="$tools.pushRouter('/coinpowerball', false)">코인 5분</div>
                                </li>
                                <li>
                        ...
                        <div class="header-mobile-menu">
                            <div class="header-mobile-menu-wrap">
                                <ul>
                                    ...
                                    <li @click="$tools.pushRouter('/coinpowerball', false)">
                                        코인 5분
                                        ...
                                        <div class="col">
                                            <div class="broadcast">
                                                <div id="frame-wrap-dream">
                                                    <iframe class="iframe-game-dream" src="https://dr-score.com/minigame/broadcast/coinpowerball5" scrolling="no"></iframe>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            timeSet() {
                let term = this.$config.coinPowerballTerm
            ...
            async getGame() {
                let r = await this.$http.get('/api/get-coinpowerball')

                if(!r.data) {
                    this.end = true
                    if(this.router === 'CoinPowerball') {
