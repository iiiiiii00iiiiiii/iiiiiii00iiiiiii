        ...
        <div class="col-12">
            ...
            <div class="content-box">
                ...
                <div class="row">
                    <div class="col">
                        <div class="title">
                            구글 1분 파워볼 <span>GOOGLE POWERBALL 1M</span>
                        </div>
                    </div>
                    <div class="col-7 text-right d-none d-xl-block">
                        <div class="minigame-menu">
                            <ul>
                                <li>
                                    <div class="active" @click="$tools.pushRouter('/googlepowerball1', false)">구글 1분</div>
                                        ...
                                        <div class="col">
                                            <div class="broadcast">
                                                <div id="frame-wrap-trust">
                                                    <iframe class="iframe-game-trust" src="https://game.tspick.com/bong/TRUST_POWERBALL/?kind=pick_powerball3" scrolling="no"></iframe>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            timeSet() {
                let term = this.$config.googlePowerball1Term
            ...
            async getGame() {
                let r = await this.$http.get('/api/get-googlepowerball1')

                if(!r.data) {
                    this.end = true
                    if(this.router === 'GooglePowerball1') {
