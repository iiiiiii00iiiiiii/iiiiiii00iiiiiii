<template>
    <div class="col-12 mt-3" v-if="v.games.x2ndQuarter && v.showConfig.x2ndQuarter && v.games.x2ndQuarter[0].status !== 'HIDE' && v.games.x2ndQuarter[0].showStatus">
        <div class="mb-1 sports-detail-title">
            <font-awesome-icon :icon="['fa', 'chevron-circle-down']" class="text-warning"/> 2쿼터 승무패
        </div>
        <div class="row">
            <div class="col-5 px-1">
                <div
                    ...
                    @click="v.games.x2ndQuarter[0].status === 'ACTIVE' ? $emit('setBet', {
                        _id: v._id,
                        sport: v.sport,
                        type: 'x',
            ...
            <div class="col-2 px-1">
                <div
                    ...
                    @click="v.games.x2ndQuarter[0].drawRate && v.games.x2ndQuarter[0].status === 'ACTIVE' ? $emit('setBet', {
                        _id: v._id,
                        sport: v.sport,
                        type: 'x',
                        homeTeam: v.homeTeamKor ? v.homeTeamKor : v.homeTeam,
