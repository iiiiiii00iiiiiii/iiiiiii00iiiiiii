<template>
    <div class="col-12 mt-3" v-if="v.games.x7thInning && v.showConfig.x7thInning && v.games.x7thInning[0].status !== 'HIDE' && v.games.x7thInning[0].showStatus">
        <div class="mb-1 sports-detail-title">
            <font-awesome-icon :icon="['fa', 'chevron-circle-down']" class="text-warning"/> 7이닝 승무패
        </div>
        <div class="row">
            <div class="col-5 px-1">
                <div
                    ...
                    @click="v.games.x7thInning[0].status === 'ACTIVE' ? $emit('setBet', {
                        _id: v._id,
                        sport: v.sport,
                        type: 'x',
            ...
            <div class="col-2 px-1">
                <div
                    ...
                    @click="v.games.x7thInning[0].drawRate && v.games.x7thInning[0].status === 'ACTIVE' ? $emit('setBet', {
                        _id: v._id,
                        sport: v.sport,
                        type: 'x',
                        homeTeam: v.homeTeamKor ? v.homeTeamKor : v.homeTeam,
