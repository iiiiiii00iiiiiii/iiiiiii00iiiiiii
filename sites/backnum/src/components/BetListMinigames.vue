                    ...
                    <div class="board-list">
                        <div class="row">
                            <div class="col text-right">
                                ...
                                <!-- <button type="button" class="btn-board ml-1" :disabled="loading" @click="getList()">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async deleteBet(_id) {
                let resultDelete = await this.$http.delete('/api/bet-delete', {
                    _id
                })
            ...
            async deleteBetAll() {
                let resultDeleteAll = await this.$http.delete('/api/bet-delete-all')
