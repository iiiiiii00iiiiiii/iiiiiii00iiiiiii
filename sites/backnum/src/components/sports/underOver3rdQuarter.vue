<template>
    ...
    >
        <div class="mb-1 sports-detail-title">
            <font-awesome-icon :icon="['fa', 'chevron-circle-down']" class="text-warning"/> 3쿼터 언더오버
        </div>
        <div class="row" :class="index > 0 && v.games.underOver3rdQuarter[index].showStatus && v.games.underOver3rdQuarter[index].status !== 'HIDE' ? 'mt-1' : ''" v-for="(vv, index) in v.games.underOver3rdQuarter" :key="index">
            <div class="col-5 px-1" v-if="v.games.underOver3rdQuarter[index].showStatus && v.games.underOver3rdQuarter[index].status !== 'HIDE'">
                <div
            ...
            <div class="col-2 px-1" v-if="v.games.underOver3rdQuarter[index].showStatus && v.games.underOver3rdQuarter[index].status !== 'HIDE'">
                <div class="g-x">
                    {{ vv.standard }}
                </div>
            </div>
