...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions(['setRouter', 'setMessageCount', 'setHelpCount', 'setHelpReplace', 'setShortNotice']),
            ...
            async getShortNotice() {
                let rShortNotice = await this.$http.get('/api/get-short-notice', null, false)
                if(rShortNotice.error) return

                this.setShortNotice(rShortNotice.data.shortNotice)
            }
        }
    }
</script>
